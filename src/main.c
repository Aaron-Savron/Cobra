...
int main(int argc, char **argv) {
    ...
    if (use_isolated_backend) {
        ...
        if (isolated_fs_source) {
            source_buffer_append(&isolated_buffer, isolated_fs_source, "lib/fs.cb");
            free(isolated_fs_source);
        }
        ...
        if (isolated_net_source) {
            source_buffer_append(&isolated_buffer, isolated_net_source, "lib/net.cb");
            free(isolated_net_source);
        }
